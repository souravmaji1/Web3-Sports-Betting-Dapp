...
export function BetCard(props: Props) {
  ...
  return (
    <div className="p-4 bg-zinc-900 text-white mt-2 first-of-type:mt-0 rounded-lg" >
      <div className={`flex items-center justify-between  ${daysone.className}`} >
      ...
      <div className={`flex items-center justify-between mt-2 flex-wrap ${daysone.className}`}>
        <div className='flex items-center'>
          <p>Bet Amount:</p>
          &nbsp;
          ...
          </div>
          {
            isRedeemed ? (
              ...
              Boolean(payout || (isCanceled && !freebetId) || isRedeemed) && (
                ...
                <button
                  className={cx(`md:w-[200px] py-3.5 text-white font-semibold text-center rounded-xl ${daysone.className}`, {
